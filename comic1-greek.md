...
<div class="col-lg-12 text-center">
	<h2 class="section-heading text-uppercase">Η ΡΕΟΛΟΓΙΑ ΤΗΣ ΓΑΤΑΣ (ΕΛΛΗΝΙΚΑ)
        ...
        <div class="text-muted">
           <a href="{{ site.url }}/downloads/comic1-greek/RC1-Greek.cbz">Κατέβασε για Comics Reader (CBZ)</a>
        </div>
        <div class="text-muted">
           <a href="{{ site.url }}/downloads/comic1-greek/RC1-Greek.pdf">Κατέβασε το PDF</a>
        </div>
