...
<div class="col-lg-12 text-center">
    ...
    <div class="text-muted">
        <a href="#pro">Print professionally</a> 
    </div>
...
<br><br>
<!-- Section for home printing options -->
<div id="home" class="col-lg-12 text-left">
    <h3>Print at home</h3>
    <p>Print double-sided on any standard printer, and then staple together into a booklet. Note: since the comic is not a standard printer paper size, there will be blank edges on the borders.<br>
    <br>
    Rheology of Cats</p>
    <ul>
...
<br><br>
<!-- Section for pro printing options -->
<div id="pro" class="col-lg-12 text-left">
    <h3>Print professionally (at your local print shop)</h3>
    <p>This document is 5 inches (width) by 7.5 inches (height). We recommend printing on 60# uncoated paper for the inner pages (text) and 80# coated paper for the cover, saddle stitched.<br>
    <br>
    Rheology of Cats</p>
    <ul>
